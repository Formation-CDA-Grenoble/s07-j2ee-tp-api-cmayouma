...
import net.bytebuddy.asm.Advice.Dispatcher.Bound;
@RestController
...
public class BrandController {
    ...
    @PutMapping("/{id}")
    public   updateBrand(@Valid @RequestBody Bound
    
    }
    @PutMapping("/{id}")
    public   updateBrand(@Valid @RequestBody Brand newBrand) {
        Brand Brand = this.fetchProduct(newBrand.getId());
